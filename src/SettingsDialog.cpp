...
void SettingsDialog::setupUI()
{
    ...
    setTabOrder(m_showArrowsCheckBox, m_autoStartCheckBox);
...
void SettingsDialog::createAppearanceGroup()
{
    ...
    layout->addWidget(lineWidthLabel, row, 0);
    ...
    layout->addWidget(offsetLabel, row, 0);
    ...
    layout->addWidget(thicknessGrowthLabel, row, 0);
